...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="css02/cdzfee.css">
</head>
<body>
<%
    ...
    if (null==user){
        ...
        List<PeopleCdz> feelist = (List<PeopleCdz>) request.getAttribute("feelist");
%>
            ...
            <table border="1">
                ...
                <%
                    if (feelist != null && !feelist.isEmpty()) {
                        for (PeopleCdz fee: feelist) {
                %>
                <tr>
                    <td><%= fee.getCdz_id() %></td>
                    <td><%= fee.getPay_cdz_time() %></td>
                    <td><%= fee.getPhone() %></td>
                    <td><%= fee.getCdz_fy() %></td>
                    <td><%= fee.getCdz_pay_zt() %></td>
                    <td>
                        <%
                    ...
                    <td>
                        <%
                            if (fee.getFinish() == null) {
                        %>
                        <form action="cdz?method=feefinish" method="post">
