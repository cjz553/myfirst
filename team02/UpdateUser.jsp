...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="css02/UpdateUser.css">
...
<div class="container">
    ...
    <div class="main-content">
        <h2>修改个人信息</h2>
        <form action="operate02?method=change_information" method="post">
            <input type="hidden" name="id" value=<%=user.getId()%>>
            姓名: <input type="text" name="name" required value=<%=user.getName()%>><br>
            电话: <input type="text" name="phone" required value=<%=user.getPhone()%>><br>
            学号: <input type="text" name="student_id" required value=<%=user.getStudent_id()%>><br>
            年级: <input type="text" name="grade" required value=<%=user.getGrade()%>><br>
            专业: <input type="text" name="profession" required value=<%=user.getProfession()%>><br>
            学校: <input type="text" name="school" required value=<%=user.getSchool()%>><br>
