...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="css02/czdetail.css">
</head>
<body>
<%
...
<div class="container">
    ...
    <div class="main-content">
        ...
        <div id="go">
            <h2><%=cdz_id%></h2>
            <form action="cdz?method=cd" method="post">
                <label for="cph">输入车牌号:</label>
                <input type="text" name="cph" id="cph" required>
                <input type="hidden" name="phone" value=<%=user.getPhone()%>>
                <input type="hidden" name="cdz_id" value=<%=cdz_id%>>
                <input type="submit" value="开始充电">
            </form>
        </div>
