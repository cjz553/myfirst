...
<head>
    ...
    <title>电池柜地图</title>
    <link rel="stylesheet" href="css02/backbattery.css">
    <style>
        #map {
            width: 100%;
            height: 500px;
            ...
            .then(data => {
                data.forEach(function(cupboard) {
                    ...
                    var infoWindow = new qq.maps.InfoWindow({
                        map: map,
                        content: '电池柜编号:'+cupboard.cupboard_id+'电池柜空位数：'+(cupboard.cupboard_hold-cupboard.count),
                        width: 500,
                        height: 100
                    });
                    ...
                    qq.maps.event.addListener(marker, 'click', function() {
                       ...
                       " <p>电池柜编号: "+cupboard.cupboard_id+"</p>"+
                        "<p>位置: 纬度 "+cupboard.lo+"              "+"经度" +cupboard.la+"</p>"+
                            ...
                            "<p>电池柜剩余空位数: "+(cupboard.cupboard_hold-cupboard.count)+"</p>"+
                            "<form action='backbattery2.jsp' method='post'>" +
                            "<input type='hidden' name='cupboard_id' value='" + cupboard.cupboard_id + "'>" +
                            "<input type='submit' value='归还电池'>" +
                            "</form>";
