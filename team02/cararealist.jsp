...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="css02/cararealist.css">
</head>
<body>
<%
    ...
    if (null==user){
        ...
        List<CarArea> cararealist = (List<CarArea>) request.getAttribute("cararealist");
%>
    ...
    <div class="main-content">
        <main>
            ...
            <table border="1">
                ...
                <tbody>
                <%
                    if (cararealist != null && !cararealist.isEmpty()) {
                        for (CarArea cararea: cararealist) {
                %>
                <tr>
                    <td><%= cararea.getCar_area_name() %></td>
                    <td>
                        <form action="cdz?method=cdzlist" method="post">
                            <input type="hidden" name="car_area_id" value="<%= cararea.getCar_area_id() %>">
