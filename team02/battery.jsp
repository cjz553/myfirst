...
<%@ page import="team02.relation.BatteryCupboard" %>
...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="css02/battery.css">
</head>
<body>
<%
    ...
    if (null==user){
        ...
        List<BatteryCupboard> batterylist = (List<BatteryCupboard>) request.getAttribute("batterylist");
%>
            ...
            <table class="battery-table">
                ...
                <%
                    if (batterylist != null && !batterylist.isEmpty()) {
                        for (BatteryCupboard battery : batterylist) {
                %>
                <tr>
                    <td><%= battery.getBattery_id() %></td>
                    <td>
                        <form action="getbattery2.jsp?" method="post">
                            ...
                            <input type="submit" value="取出电池">
                        </form>
                    </td>
                    <td>
                        <form action="batterydetail?method=look" method="post">
                            <input type="hidden" name="battery_id" value="<%= battery.getBattery_id() %>">
                            <input type="hidden" name="cupboard_id" value="<%= battery.getCupboard_id() %>">
                            <input type="submit" value="查看电池详细信息">
                        </form>
                    </td>
                </tr>
                <%
