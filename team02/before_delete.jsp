...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="css02/before_delete.css">
...
<div class="container">
    ...
    <div class="main-content">
        <h2>是否确认注销</h2>
        <a href="operate02?id=<%= user.getId() %>&method=delete" class="confirm-button">确认</a>
        <a href="javascript:history.back()" class="back-button">取消</a>
