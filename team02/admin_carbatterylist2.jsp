...
<%@ page import="team02.relation.CarBattery2" %><%--
...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="css02/admin_carbatterylist2.css">
</head>
<body>
<%
    ...
    if (null == user) {
        ...
        List<CarBattery2> carbatterylist2 = (List<CarBattery2>) request.getAttribute("carbatterylist2");
%>
...
<div class="container">
    ...
    <div class="search-box">
        <form action="AdminBatteryServlet?method=search_carbattery2" method="post">
            <label for="search_input"></label><input type="text" name = "search_input" id="search_input" placeholder="输入电池编号,车牌号，手机号等关键词...">
    ...
    <div class="main-content">
        <main>
            ...
            <table class="battery-table">
                ...
                <tbody>
                <%
                    if ( carbatterylist2 != null && ! carbatterylist2.isEmpty()) {
                        for (CarBattery2 cb2 :  carbatterylist2) {
                %>
                <tr>
                    <td><%= cb2.getCph()%></td>
                    <td><%= cb2.getBattery_id() %></td>
                    <td><%= cb2.getChange_time()%></td>
                    <td>
                        <%
                            if (cb2.getBack_time()==null){
                                out.print("未归还");
                            }else {
                                out.print(cb2.getBack_time());
                            }
                        %>
                    </td>
                    <td><%= cb2.getPhone()%></td>
