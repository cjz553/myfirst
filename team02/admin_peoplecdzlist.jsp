...
<%@ page import="team02.relation.PeopleCdz" %><%--
...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="css02/admin_peoplecdzlist.css">
</head>
<body>
<%
    ...
    if (null == user) {
        ...
        List<PeopleCdz> peoplecdzlist = (List<PeopleCdz>) request.getAttribute("peoplecdzlist");
%>
...
<div class="container">
    ...
    <div class="search-box">
        <form action="AdminUserServlet?method=search1" method="post">
    ...
    <div class="main-content">
        <main>
            ...
            <table class="battery-table">
                ...
                <tbody>
                <%
                    if ( peoplecdzlist != null && !peoplecdzlist.isEmpty()) {
                        for (PeopleCdz cb1 :  peoplecdzlist) {
                %>
                <tr>
                    <td><%= cb1.getCdz_id()%></td>
                    <td><%= cb1.getPhone()%></td>
                    <td><%= cb1.getPay_cdz_time()%></td>
                    <td><%= cb1.getCdz_fy()%></td>
                    <td><%= cb1.getCdz_pay_zt()%></td>
                    <td>
                        <%
