...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="css02/car_give.css">
</head>
<body>
<%
...
<div class="container">
    ...
    <div class="main-content">
        <div id="changeForm" >
            <h2>车辆转让</h2>
            <form action="car?method=change" method="post">
                <input type="hidden" id="phone1" name="phone1" value=<%=user.getPhone()%> required/><br><br>

                <label for="cph">输入转让车牌号:</label>
                <input type="text" id="cph" name="cph" required/><br><br>

                <label for="phone2">输入转让人电话:</label>
                <input type="text" id="phone2" name="phone2" required/><br><br>
