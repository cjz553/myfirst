...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="css02/lookInformations.css">
...
<div class="container">
    ...
    <div class="main-content">
        <div class="container">
            <div class="info-title">您的账户信息</div>
            <ul class="info-list">
                <li><span>姓名:</span><span><%= user.getName()%></span></li>
                <li><span>身份证号:</span><span><%= user.getId() %></span></li>
                <li><span>电话号码:</span><span><%= user.getPhone() %></span></li>
                <li><span>注册日期:</span><span><%= user.getPeople_registration() %></span></li>
                <li><span>学校:</span><span><%= user.getSchool()%></span></li>
                <li><span>年级:</span><span><%= user.getGrade() %></span></li>
                <li><span>专业:</span><span><%= user.getProfession()%></span></li>
                <li><span>学号:</span><span><%= user.getStudent_id() %></span></li>
                <li><span>账户密码:</span><span><%= user.getPassword()%></span></li>
                <li><span>账户余额:</span><span><%= user.getAccounts() %></span><button><a href="recharge.jsp">充值</a></button></li>
            </ul>
        </div>
        <!-- 广告信息 -->
        <div class="ad-banner">
