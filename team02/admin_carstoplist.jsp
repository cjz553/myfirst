...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="css02/admin_carstoplist.css">
</head>
<body>
<%
    ...
    if (null == user) {
        ...
        List<AreaCar2> carstoplist = (List<AreaCar2>) request.getAttribute("carstoplist");
%>
...
<div class="container">
    ...
    <div class="search-box">
        <form action="AdminCarServlet?method=search" method="post">
            ...
            <table class="battery-table">
                ...
                <%
                    if ( carstoplist != null && ! carstoplist.isEmpty()) {
                        for (AreaCar2 cb1 :  carstoplist) {
                %>
                <tr>
                    <td><%= cb1.getCar_area_id()%></td>
                    <td><%= cb1.getCph() %></td>
                    <td><%= cb1.getCf_time()%></td>
                    <td><%= cb1.getLa()%></td>
                    <td><%= cb1.getLo()%></td>
                    <td><%= cb1.getPhone()%></td>
                </tr>
